...
void set_load_setting(gchar *filename)
{
    gboolean flag = TRUE;
    gint value_int = 0;
...
void set_save_setting()
{
    ...
    rc_setting.repeat_mode = gcore->repeat;
    rc_setting.random_mode = gcore->random;
    rc_setting.volume = gcore->volume;
    GKeyFile *sys_keyfile = g_key_file_new();
