...
gboolean plist_insert_list(gchar *, gint);
gboolean plist_insert_music(gchar *, gint, gint);
...
void plist_set_list_name(gint, gchar *);
...
void plist_plist_move(gint, gint *, gint, gint);
void plist_plist_move2(gint, gint*, gint, gint);
void plist_delete_music2(gint, gint*, gint);
void plist_reflesh_info(gint);
void plist_save_playlist(gchar *, gint);
void plist_load_playlist(gchar *, gint);
