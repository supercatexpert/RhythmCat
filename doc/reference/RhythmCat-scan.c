...
extern GType rc_player_get_type (void);
extern GType rc_shell_get_type (void);

#ifdef GTK_IS_WIDGET_CLASS
#include <gtk/gtk.h>
#endif
GType object_types[3];
...
get_object_types (void)
{
    ...
    gint i = 0;
    object_types[i++] = rc_player_get_type ();
    object_types[i++] = rc_shell_get_type ();
    object_types[i] = 0;
...
/* The output files */
const gchar *signals_filename = "./RhythmCat.signals.new";
const gchar *hierarchy_filename = "./RhythmCat.hierarchy.new";
const gchar *interfaces_filename = "./RhythmCat.interfaces.new";
const gchar *prerequisites_filename = "./RhythmCat.prerequisites.new";
const gchar *args_filename = "./RhythmCat.args.new";
